...
def addElement(linked_list, value):
    ...
    new_link = LinkedList(value, previous=linked_list)
...
def insertElement(linked_list, value, index):
    ...
    if index == 0:
        new_link = LinkedList(value, is_start=True)
        ...
        new_link = LinkedList(value, previous=link_previous)
        new_link.setLinkNext(linked_list)
