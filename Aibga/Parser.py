...
from ATS import AssignNode, OperationNode, WhileNode, IfNode, LinkedListNode, PrintNode, LinkedListOperatioinNode
import Errors
    ...
    def parse(self):
        ...
        for ii in range(len(self.kod)):
            ...
            if line[-1].getTypeToken() != "SEMICOLON":
                raise Errors.NotSemicolon(ii + 1)
            ...
            if line[0].getTypeToken() == "VAR" and line[1].getTypeToken() == "ASSIGNMENT":
                ...
                raise Errors.FalseKod(line[1].getValue(), ii + 1)
